...
namespace ThiExam.Infrastructure.Migrations
{
    ...
    [Migration("20260109035508_ReorganizedStructure")]
    partial class ReorganizedStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.ExamQuestion", b =>
                {
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.ExamSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.ProctoringLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.QuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.StudentAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Category", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.Category", "Parent")
                        .WithMany("InverseParent")
                        .HasForeignKey("ParentId")
                        .HasConstraintName("FK_categories_parent");

                    b.HasOne("ThiExam.Core.Entities.User", "Teacher")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.ExamQuestion", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.Exam", "Exam")
                    ...
                    b.HasOne("ThiExam.Core.Entities.Question", "Question")
                        .WithMany("ExamQuestions")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.ProctoringLog", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.StudentAttempt", "Attempt")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.Question", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.Category", "Category")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.StudentAnswer", b =>
                {
                    ...
                    b.HasOne("ThiExam.Core.Entities.QuestionOption", "SelectedOption")
                        .WithMany("StudentAnswers")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.StudentAttempt", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.ExamSession", "Session")
                        .WithMany("StudentAttempts")
                        .HasForeignKey("SessionId")
                        .HasConstraintName("FK_attempts_session");

                    b.HasOne("ThiExam.Core.Entities.User", "Student")
                        .WithMany("StudentAttempts")
            ...
            modelBuilder.Entity("ThiExam.Core.Entities.User", b =>
                {
                    b.HasOne("ThiExam.Core.Entities.Role", "Role")
                        .WithMany("Users")
